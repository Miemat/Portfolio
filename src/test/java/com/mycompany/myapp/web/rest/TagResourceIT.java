...
public class TagResourceIT {
    ...
    public void createTag() throws Exception {
        ...
        // Create the Tag
        restTagMockMvc
            .perform(post("/api/tags").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(tag)))
    ...
    public void updateTag() throws Exception {
        ...
        restTagMockMvc
            .perform(put("/api/tags").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedTag)))
            .andExpect(status().isOk());
    ...
    public void updateNonExistingTag() throws Exception {
        ...
        restTagMockMvc
            .perform(put("/api/tags").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(tag)))
            .andExpect(status().isBadRequest());
    ...
    public void deleteTag() throws Exception {
        ...
        // Delete the tag
        restTagMockMvc.perform(delete("/api/tags/{id}", tag.getId()).accept(MediaType.APPLICATION_JSON)).andExpect(status().isNoContent());

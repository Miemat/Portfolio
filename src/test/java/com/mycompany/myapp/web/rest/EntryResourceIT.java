...
public class EntryResourceIT {
    ...
    public void createEntry() throws Exception {
        ...
        // Create the Entry
        restEntryMockMvc
            .perform(post("/api/entries").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(entry)))
    ...
    public void updateEntry() throws Exception {
        ...
        restEntryMockMvc
            .perform(put("/api/entries").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedEntry)))
            .andExpect(status().isOk());
    ...
    public void updateNonExistingEntry() throws Exception {
        ...
        restEntryMockMvc
            .perform(put("/api/entries").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(entry)))
            .andExpect(status().isBadRequest());
    ...
    public void deleteEntry() throws Exception {
        ...
        // Delete the entry
        restEntryMockMvc
            .perform(delete("/api/entries/{id}", entry.getId()).accept(MediaType.APPLICATION_JSON))
